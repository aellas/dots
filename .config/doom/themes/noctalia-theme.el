...
(let* ((bg "#111117")
      ...
      (on-primary "#161616")
      (on-primary-container "#d3daf8")
      (on-secondary "#161616")
      (on-secondary-container "#e3e4e8")
      (on-surface "#f2f4f8")
      ...
      (primary "#bfc9f4")
      (primary-container "#143ded")
      (secondary "#6c7086")
      (secondary-container "#1c1f30")
      (shadow "#000000")
      (surface "#111117")
      (surface-container "#111117")
      (surface-container-high "#1a1a23")
      (surface-container-highest "#22222e")
      (surface-container-low "#111117")
      (surface-container-lowest "#111117")
      (surface-variant "#111117")
      (tertiary "#be95ff")
