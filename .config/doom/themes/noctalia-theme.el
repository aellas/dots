...
(let* ((bg "#1f1f28")
      (err "#c34043")
      (err-container "#430d0e")
      (on-background "#c8c093")
      (on-err "#1f1f28")
      (on-err-container "#f3d8d9")
      (on-primary "#1f1f28")
      (on-primary-container "#e4eae1")
      (on-secondary "#1f1f28")
      (on-secondary-container "#f0e8db")
      (on-surface "#c8c093")
      (on-surface-variant "#717c7c")
      (on-tertiary "#1f1f28")
      (on-tertiary-container "#d8e1f3")
      (outline-color "#676785")
      (outline-variant "#46465a")
      (primary "#76946a")
      (primary-container "#21321a")
      (secondary "#c0a36e")
      (secondary-container "#5f481c")
      (shadow "#1f1f28")
      (surface "#1f1f28")
      (surface-container "#2a2a37")
      (surface-container-high "#333343")
      (surface-container-highest "#3c3c4e")
      (surface-container-low "#24242f")
      (surface-container-lowest "#21212b")
      (surface-variant "#2a2a37")
      (tertiary "#7e9cd8")
      (tertiary-container "#1a3f8a")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#7e9cd8")
      (on-success "#1f1f28")
      (success-container "#1a3f8a")
      (on-success-container "#d8e1f3")
      ;; Map fixed colors to regular colors
      (primary-fixed "#76946a")
      (primary-fixed-dim "#21321a")
      (secondary-fixed "#c0a36e")
      (secondary-fixed-dim "#5f481c")
      (tertiary-fixed "#7e9cd8")
      (tertiary-fixed-dim "#1a3f8a")
      (on-primary-fixed "#1f1f28")
      (on-primary-fixed-variant "#e4eae1")
      (on-secondary-fixed "#1f1f28")
      (on-secondary-fixed-variant "#f0e8db")
      (on-tertiary-fixed "#1f1f28")
      (on-tertiary-fixed-variant "#d8e1f3")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#c8c093")
