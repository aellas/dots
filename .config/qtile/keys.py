...
keys = [
    ...
    Key([mod], "space",  lazy.spawn("rofi -show drun -modi drun -line-padding 4 -hide-scrollbar -show-icons"),         desc="App launcher"),
    Key([mod], "m",      lazy.spawn("feishin --ozone-platform=wayland"),                                               desc="Music"),
    Key([mod], "d",      lazy.spawn("vesktop"),                                                                        desc="Discord"),
    Key([mod], "n",      lazy.spawn("wezterm -e joshuto"),                                                             desc="File manager (TUI)"),
    Key([mod, "shift"], "n", lazy.spawn("dolphin"),                                                                    desc="File manager (GUI)"),
    Key([mod], "Return", lazy.spawn("wezterm"),                                                                        desc="Terminal"),
    Key([mod, "shift"], "p", lazy.spawn("sh ~/.config/qtile/scripts/power.sh", shell=True),                              desc="Power"),
    # --- Focus ---
